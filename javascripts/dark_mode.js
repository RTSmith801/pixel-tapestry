const moonIconBlue = "icons/moon_icon_blue.png";
const sunIconGold = "icons/sun_icon_gold.png";
const linkedinIconBlue = "icons/linkedin_icon_blue.png";
const linkedinIconGold = "icons/linkedin_icon_gold.png";
const githubIconBlue = "icons/github-mark-blue.svg";
const githubIconGold = "icons/github-mark-gold.svg";
const resumeIconBlue = "icons/resume_icon_blue.png";
const resumeIconGold = "icons/resume_icon_gold.png";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const linkedin_buttons = [
    document.getElementById("linkedinIcon"),
    document.getElementById("linkedinIconMobile"),
  ];

  const github_buttons = [
    document.getElementById("githubIcon"),
    document.getElementById("githubIconMobile"),
  ];
  const resume_buttons = [
    document.getElementById("resumeIcon"),
    document.getElementById("resumeIconMobile"),
  ];
  ...
  function toggleDarkMode() {
    ...
    elements_accent.forEach((el) => {
      ...
      if (!el.dataset.originalShadow)
        el.dataset.originalShadow = computed.boxShadow;
